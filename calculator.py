...
def light_mode():
    ...
    light_mode_button.config(bg='black', fg='white')
    dark_mode_button.config(bg='white', fg='black')

    display_frame.config(bg='gray')
    clear_del_frame.config(bg='gray')
...
def dark_mode():
    ...
    clear_del_frame.config(bg='black')
...
################frames################
display_frame = tk.Frame(root, bg='darkgray', borderwidth=5)
display_frame.pack()

clear_del_frame = tk.Frame(root, bg='darkgray', borderwidth=5)
clear_del_frame.pack()

one_4_7_frame = tk.Frame(root, bg='darkgray', borderwidth=5)
one_4_7_frame.pack(side='left')

two_5_8_frame = tk.Frame(root, bg='darkgray', borderwidth=5)
two_5_8_frame.pack(side='left')

three_6_9_frame = tk.Frame(root, bg='darkgray', borderwidth=5)
three_6_9_frame.pack(side='left')

operator_frame = tk.Frame(root, bg='darkgray', borderwidth=5)
operator_frame.pack(side='right')

equal_parentheses_frame = tk.Frame(root, bg='darkgray', borderwidth=5)
equal_parentheses_frame.pack(side='bottom', anchor='sw')

on_off_frame = tk.Frame(root, bg='darkgray', borderwidth=5)
on_off_frame.pack()
################frames################
